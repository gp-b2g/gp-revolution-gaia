...
template <>
struct PrototypeIDMap<mozilla::dom::SourceBufferList>
{
  enum
  {
    PrototypeID = prototypes::id::SourceBufferList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SourceBufferListBinding {
  ...
  inline JS::Handle<JSObject*> GetProtoObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    if (!protoAndIfaceArray[prototypes::id::SourceBufferList]) {
     ...
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[prototypes::id::SourceBufferList].address());
  }
  ...
  inline JS::Handle<JSObject*> GetConstructorObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JS::Heap<JSObject*>* protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    if (!protoAndIfaceArray[constructors::id::SourceBufferList]) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
    }
     ...
     * changed after they have been set.
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[constructors::id::SourceBufferList].address());
  }
