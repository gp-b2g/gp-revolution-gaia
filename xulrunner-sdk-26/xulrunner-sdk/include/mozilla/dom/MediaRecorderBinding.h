...
template <>
struct PrototypeIDMap<mozilla::dom::MediaRecorder>
{
  enum
  {
    PrototypeID = prototypes::id::MediaRecorder
  };
};
} // namespace dom
} // namespace mozilla
...
namespace MediaRecorderBinding {
  ...
  inline JS::Handle<JSObject*> GetProtoObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    if (!protoAndIfaceArray[prototypes::id::MediaRecorder]) {
     ...
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[prototypes::id::MediaRecorder].address());
  }
  ...
  inline JS::Handle<JSObject*> GetConstructorObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JS::Heap<JSObject*>* protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    if (!protoAndIfaceArray[constructors::id::MediaRecorder]) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
    }
     ...
     * changed after they have been set.
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[constructors::id::MediaRecorder].address());
  }
