...
template <>
struct PrototypeIDMap<nsMimeTypeArray>
{
  enum
  {
    PrototypeID = prototypes::id::MimeTypeArray
  };
};
} // namespace dom
} // namespace mozilla
...
namespace MimeTypeArrayBinding {
  ...
  inline JS::Handle<JSObject*> GetProtoObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    if (!protoAndIfaceArray[prototypes::id::MimeTypeArray]) {
     ...
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[prototypes::id::MimeTypeArray].address());
  }
  ...
  inline JS::Handle<JSObject*> GetConstructorObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JS::Heap<JSObject*>* protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    if (!protoAndIfaceArray[constructors::id::MimeTypeArray]) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
    }
     ...
     * changed after they have been set.
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[constructors::id::MimeTypeArray].address());
  }
