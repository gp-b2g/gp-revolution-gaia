...
struct PrototypeTraits<prototypes::id::TouchList>
{
  ...
  typedef nsDOMTouchList NativeType;
};
template <>
struct PrototypeIDMap<nsDOMTouchList>
{
  enum
  {
    PrototypeID = prototypes::id::TouchList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace TouchListBinding {
  ...
  inline JS::Handle<JSObject*> GetProtoObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    if (!protoAndIfaceArray[prototypes::id::TouchList]) {
     ...
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[prototypes::id::TouchList].address());
  }
  ...
  inline JS::Handle<JSObject*> GetConstructorObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JS::Heap<JSObject*>* protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    if (!protoAndIfaceArray[constructors::id::TouchList]) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
    }
     ...
     * changed after they have been set.
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[constructors::id::TouchList].address());
  }
  ...
  JSObject*
  Wrap(JSContext* aCx, JS::Handle<JSObject*> aScope, nsDOMTouchList* aObject, nsWrapperCache* aCache);
