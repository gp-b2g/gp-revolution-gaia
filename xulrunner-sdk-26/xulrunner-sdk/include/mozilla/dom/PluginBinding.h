...
template <>
struct PrototypeIDMap<nsPluginElement>
{
  enum
  {
    PrototypeID = prototypes::id::Plugin
  };
};
} // namespace dom
} // namespace mozilla
...
namespace PluginBinding {
  ...
  inline JS::Handle<JSObject*> GetProtoObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    if (!protoAndIfaceArray[prototypes::id::Plugin]) {
     ...
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[prototypes::id::Plugin].address());
  }
  ...
  inline JS::Handle<JSObject*> GetConstructorObject(JSContext* aCx, JS::Handle<JSObject*> aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JS::Heap<JSObject*>* protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    if (!protoAndIfaceArray[constructors::id::Plugin]) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
    }
     ...
     * changed after they have been set.
     */
    return JS::Handle<JSObject*>::fromMarkedLocation(protoAndIfaceArray[constructors::id::Plugin].address());
  }
